...
alToEL <- function(adj_list) {
    .Call('_dbscan_alToEL', PACKAGE = 'dbscan', adj_list)
}
...
simplifiedTree_hclust <- function(hcl, min_sz) {
    .Call('_dbscan_simplifiedTree_hclust', PACKAGE = 'dbscan', hcl, min_sz)
}
...
computeVirtualNodeEL <- function(noise, constraints) {
    .Call('_dbscan_computeVirtualNodeEL', PACKAGE = 'dbscan', noise, constraints)
}

fosc <- function(cl_tree, cid, sc, cl_hierarchy, alpha = 0, n_constraints = 0L, constraints = NULL) {
    .Call('_dbscan_fosc', PACKAGE = 'dbscan', cl_tree, cid, sc, cl_hierarchy, alpha, n_constraints, constraints)
}

extractUnsupervised <- function(cl_tree) {
    .Call('_dbscan_extractUnsupervised', PACKAGE = 'dbscan', cl_tree)
}

extractSemiSupervised <- function(cl_tree, constraints, alpha = 0) {
    .Call('_dbscan_extractSemiSupervised', PACKAGE = 'dbscan', cl_tree, constraints, alpha)
}
